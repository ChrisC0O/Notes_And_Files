...
|6|VirtuelBox|Make virtual machines:|[https://www.virtualbox.org/](https://www.virtualbox.org/wiki/Downloads) |
...
|54|Insomnia|Open Source API Development Ecosystem:|https://github.com/Kong/insomnia/ |
...
|68|7zip|Compress and Encrypt files:|https://www.7-zip.org/ |
|69|Waterfox|Private Web Browser:|https://www.waterfox.net/ |
|70|Bruno|API Development:|https://www.usebruno.com/ |
...
|76|Directshare|In Browser Decentralized File Sharing:|https://directshare.io/ |
...
|LMMS|Make Music. Alternative to FL Studio/ProTools:|https://lmms.io/ |
|VCV Rack2|Virtual Eurorack Studio:|https://vcvrack.com/Rack/ |

### Video:
|Program:|Use:|Url:|
|:-|:-|:-|
|VLC|Media Player:|https://www.videolan.org/vlc/  |
|FFMPEG|Robust Video Converter:|https://www.ffmpeg.org/ |
...
|Program:|Use:|Url:|
|:-|:-|:-|
|IrfanView|Lightweight Image Viewer:|https://www.irfanview.com/  |
|GIMP|Image Manipulation (Open Source Photoshop):|https://www.gimp.org/ |
...
|Program:|Use:|Url:|
|:-|:-|:-|
|Firefox|Internet Browser:|https://www.mozilla.org/ |
...
|Program:|Use:|Url:|
|:-|:-|:-|
|PyCharm|Python IDE (Community Edition):|[https://www.jetbrains.com/](https://www.jetbrains.com/pycharm/download/?section=windows)|
|IntelliJ|Java and Kotlin IDE (Community Edition):|[https://www.jetbrains.com/](https://www.jetbrains.com/idea/download/?section=windows/) |
|Alacritty|Terminal Emulator:|https://alacritty.org/ |
|Neovim|Vim-based Text Editor:|https://neovim.io/ |
|Emacs|Text Editor:|[https://www.gnu.org/](https://www.gnu.org/software/emacs/) |
...
|Atuin|Better Shell History:|https://atuin.sh/ |
|Fd|User-friendly Alternative To 'find':|https://github.com/sharkdp/fd/ |
|Ripgrep|Better Alternative to grep:|https://github.com/BurntSushi/ripgrep/ |
...
|Program:|Use:|Url:|
|:-|:-|:-|
|TeamViewer|Remote Desktop (Free for Personal use)|[https://www.teamviewer.com/](https://www.teamviewer.com/en/download/windows/) |
|LibreOffice|Open Source Microsoft Word:|https://www.libreoffice.org/ |
|Thunderbird|Mail, Calendar, and Contacts:|https://www.thunderbird.net/ |
|Okular|Opensource Adobe Reader:|https://okular.kde.org/ |
...
|Burp Suite|Monitor HTTP Requests:|[https://portswigger.net/](https://portswigger.net/burp/releases/professional-community-2024-4-5?requestededition=community&requestedplatform=) |
|TrID|File Identifier:|https://www.mark0.net/soft-trid-e.html |
|HxD|Hex Editor and Viewer (Windows):|https://www.majorgeeks.com/files/details/hxd.html |
|Okteta|Hex Editor and Viewer (Linux):|https://apps.kde.org/okteta/ |
|Ninite|Install and Update All Your Programs at Once:|https://ninite.com/ |
|Everything|File Search tool (Windows):|https://www.voidtools.com/ |
|Yabai|Window Management Utility:|https://github.com/koekeishiya/yabai/ |
|HomeBrew|Package Manager for macOS:|https://brew.sh/ |
|Filelight|Graphical Disk Usage Analyzer:|https://apps.kde.org/ |
|PeaZip|Open Source File Compression and Encryption:|https://peazip.github.io/ |
|WinDirStat|Windows Disk Usage Statistics And Cleanup Tool:|[https://windirstat.net/](https://windirstat.net/download.html/) |
|x64dbg|Open Source x64/x32 Debugger for Windows:|https://x64dbg.com/ |
|7zip|Compress and Encrypt files:|https://www.7-zip.org/ |
### Developer Tools:
|Program:|Use:|Url:|
|:-|:-|:-|
|Hoppscotch|Open Source API Development Ecosystem (Web Based):|https://hoppscotch.io/ |
|DevToys|A Swiss Army Knife for Developers:|https://github.com/DevToys-app/DevToys |
|Insomnia|Open Source API Development Ecosystem:|https://github.com/Kong/insomnia/ |
|Ntfy|Send push notifications to your phone(GET/POST):|https://ntfy.sh/ |
|Bruno|API Development:|https://www.usebruno.com/ |
|Git|Distributed Version Control (Github):|https://www.git-scm.com/ |
